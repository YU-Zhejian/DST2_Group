				...
				<div class="container">
					<div class="row">
						...
						<div class="col-8 col-7-large col-12-medium">
							...
							<a href="welcome.jsp" class="button large scrolly">Login in</a>
...
<div class="title">KJDFIOGJIOPJR'PJF;KJFPIJ''OIJR;FOIREJO;FERNHGV;NH</div>
			<article id="Drug" class="wrapper style2">
                <%@include file="drugs.jsp" %>
			</article>

			<article id="La" class="wrapper style3">
			    <%@include file="drugLabel.jsp" %>
			</article>	

			<article id="Dosage" class="wrapper style3">
				<%@include file="guideline.jsp" %>
			</article>
